...
typedef struct _list_node_pool list_node_pool_t;
...
#define list_erase_nth_node(list_p, idx) \
    list_remove(list_p, list_get_nth_node(list_p, idx))
...
#define list_length(list_p) (list_p)->length
